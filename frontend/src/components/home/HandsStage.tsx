  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute top-0 left-0">
        <p className="mono text-[10px] uppercase tracking-[0.22em] text-primary">Now forming</p>
        <p className="serif mt-1.5 text-[1.6rem] leading-tight">{mudra.name}</p>
        <p className="serif text-[1rem] italic text-foreground/55">{mudra.meaning}</p>
      </div>

      <p className="mono pointer-events-none absolute top-1 right-0 hidden items-center gap-2 text-[10px] uppercase tracking-[0.16em] text-foreground/40 sm:flex">
