...
const PLATFORM = [
  ...
  { href: "/library", label: "Mudra library" },
        ...
        <div className="grid gap-12 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)_minmax(0,1fr)]">
          <div>
            ...
            <p className="serif text-[0.98rem] leading-[1.6] text-foreground/55 mt-5 max-w-sm">
              Real-time recognition of Bharatanatyam hand gestures, running entirely in the
              browser. No frame of video leaves the device.
            </p>
